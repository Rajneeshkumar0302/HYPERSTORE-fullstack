...
<div className="relative transition-all duration-400 ease-in-out
               w-[clamp(10rem,22vw,20rem)] focus-within:w-[clamp(12rem,24vw,27rem)]
                ">
<input type="text" placeholder="Search" style={{ backgroundColor:"white" ,padding:"1rem 2.2rem 1rem 1rem", }}
